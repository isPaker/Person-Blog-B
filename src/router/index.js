...
export const constantRoutes = [
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '文章分类', icon: 'el-icon-s-operation', auth: true }
      },
      {
        path: '/addBlog',
        name: 'AddBlog',
...

  {
    ...
    component: Layout,
    hidden: true,
    meta: { children: ['/personSetting'] },
    children: [
      {
        path: '/personSetting',
        name: 'PersonSetting',
        component: () => import('@/views/personSetting/index'),
        meta: { title: '个人中心', icon: 'el-icon-s-custom', auth: true }
      }
    ]
  },
